...
@PluginDescriptor(
	...
	description = "MK plugin utilities"
)
@Slf4j
@SuppressWarnings("unused")
@Singleton
public class MKUtils extends Plugin
{
	@Inject
	...
	@Provides
	MKUtilsConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(MKUtilsConfig.class);
	}
	...
	public void doGameObjectActionClientTick(GameObject object, int menuOpcodeID, long ticksToDelay)
	{
		...
		Rectangle rectangle = object.getConvexHull().getBounds();
		if (rectangle == null)
		{
			rectangle = new Rectangle(client.getCenterX() - 50, client.getCenterY() - 50, 100, 100);
		}
	...
	{
		if (!event.getGroup().equalsIgnoreCase("mkutils"))
		{
			return;
		}
	}
	...
	public void doTileObjectActionClientTick(TileObject object, int menuOpcodeID, long ticksToDelay)
	{
		...
		Rectangle rectangle = object.getCanvasTilePoly().getBounds();
		if (rectangle == null)
		{
			rectangle = new Rectangle(client.getCenterX() - 50, client.getCenterY() - 50, 100, 100);
		}
	...
	public void doNpcActionClientTick(NPC npc, int menuOpcodeID, long ticksToDelay)
	{
		...
		Rectangle rectangle = npc.getConvexHull().getBounds();
		if (rectangle == null)
		{
			rectangle = new Rectangle(client.getCenterX() - 50, client.getCenterY() - 50, 100, 100);
		}
	...
	public void doGameObjectActionMsTime(GameObject object, int menuOpcodeID, long timeToDelay)
	{
		...
		if (convexHull != null)
		{
			rectangle = convexHull.getBounds();
		}
