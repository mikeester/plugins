...
class TemplateOverlay extends OverlayPanel
{
	...
	@Inject
	private TemplateOverlay(final Client client, final TemplatePlugin plugin, final TemplateConfig config, final ModelOutlineRenderer modelOutlineRenderer)
	{
		super(plugin);
		...
		getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "MK Template overlay"));
	}
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		String titleString = "MK Template";
